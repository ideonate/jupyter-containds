...
man_pages = [
    (master_doc, "jupyter-containds", "jupyter-containds Documentation", [author], 1)
]
...
# Set the nbsphinx_widgets_path empty can avoid showing twice of the widgets
